...
public class DriveSubsystem extends SubsystemBase {
  ...
  /**
   * The Singleton instance of this DriveSubsystem. Code should use the {@link #getInstance()}
   * method to get the single instance (rather than trying to construct an instance of this class.)
   */
  private static final DriveSubsystem INSTANCE = new DriveSubsystem();

  /**
   * Returns the Singleton instance of this DriveSubsystem. This static method should be used,
  ...
  /**
   * Creates a new instance of this DriveSubsystem. This constructor is private since this class is
